...
class Data_sub_biaya extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('v_data_sub_biaya', array(
	...
	public function simpan(){
		$result = $this->M_master->simpan_sub_biaya('tbl_sub_biaya', array(
		...
		if($result>0){
			echo '<script>alert("Data Sub Biaya Tersimpan");window.location="index"</script>';
		}
	}

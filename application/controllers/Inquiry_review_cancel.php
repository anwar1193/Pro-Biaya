...
class Inquiry_review_cancel extends CI_Controller {
	...
	public function index()
	{
		...
		$data_inquiry = $this->M_master->tampil_review_cancel($departemen)->result_array();
		...
		$this->load->view('v_inquiry_review_cancel', array('data_inquiry' => $data_inquiry));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_inquiry_review_cancel_detail', array(

...
class Relasi_sub extends CI_Controller {
	...
	{
		cek_belum_login();
		$data_relasi_sub = $this->M_master->tampil_relasi_sub()->result_array();
		$data_sub_biaya = $this->M_master->tampil_sub_biaya()->result_array();
		...
		$this->load->view('v_relasi_sub', array(
			'data_relasi_sub' => $data_relasi_sub,
	...
	public function tambah(){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_relasi_sub_tambah', array(
			'data_sub_biaya' => $data_sub_biaya,
			'data_departemen' => $data_departemen
		));
		$this->load->view('footer');
	...
	public function simpan(){
		$result = $this->M_master->simpan_relasi('tbl_relasi_sub', array(

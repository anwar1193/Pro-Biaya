...
class P_telah_dibayar extends CI_Controller {
  ...
  public function index()
  {
    ...
    if($cabang=='HEAD OFFICE'){
      $data_telbay = $this->M_master->tampil_telbayHO($departemen)->result_array();
      $identitas = $departemen;
    }else{
      $data_telbay = $this->M_master->tampil_telbay($cabang, $level)->result_array();
      $identitas = $level;
    }
    ...
    $this->load->view('v_p_telah_dibayar', array('data_telbay' => $data_telbay));
  ...
  public function detail($id){
    ...
    $this->load->view('header');
    $this->load->view('sidebar', array('data_jb'=>$data_jb));
    $this->load->view('v_p_detail_telbay', array(

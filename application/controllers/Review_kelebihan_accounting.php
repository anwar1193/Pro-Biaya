...
class Review_kelebihan_accounting extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('v_review_kelebihan_acc', array('data_review' => $data_review));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_review_kelebihan_detail_acc', array(
	...
	public function verifikasi(){
        ...
        if($update_status > 0){
            ...
            redirect('review_kelebihan_accounting');
        }
    }

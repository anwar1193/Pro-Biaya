...
class P_rejected extends CI_Controller {
	...
	public function index()
	{
		...
		if($cabang=='HEAD OFFICE'){
			$data_rejected = $this->M_master->tampil_rejectedHO($departemen)->result_array();
			$identitas = $departemen;
		}else{
			$data_rejected = $this->M_master->tampil_rejected($cabang, $level)->result_array();
			$identitas = $level;
		}
		...
		$this->load->view('v_p_rejected', array('data_rejected' => $data_rejected));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_p_detail_rejected', array(

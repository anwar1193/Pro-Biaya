...
class P_dokumen_pending extends CI_Controller {
	...
	public function index()
	{
		...
		if($cabang=='HEAD OFFICE'){
			$data_pendok = $this->M_master->tampil_pendokHO($departemen)->result_array();
			$identitas = $departemen;
		}else{
			$data_pendok = $this->M_master->tampil_pendok($cabang, $level)->result_array();
			$identitas = $level;
		}
		...
		$this->load->view('v_p_dokumen_pending', array('data_pendok' => $data_pendok));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_p_detail_pendok', array(

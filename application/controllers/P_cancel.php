...
class P_cancel extends CI_Controller {
	...
	public function index()
	{
		...
		if($cabang=='HEAD OFFICE'){
			$data_cancel = $this->M_master->tampil_cancelHO($departemen)->result_array();
			$identitas = $departemen;
		}else{
			$data_cancel = $this->M_master->tampil_cancel($cabang, $level)->result_array();
			$identitas = $level;
		}
		...
		$this->load->view('v_p_cancel', array('data_cancel' => $data_cancel));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_p_cancel_detail', array(

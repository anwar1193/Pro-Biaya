...
class Inquiry_kekurangan_biaya_all extends CI_Controller {
	...
	public function index()
	{
        ...
        $data_inquiry = $this->db->query("SELECT * FROM tbl_penyelesaian_kekurangan INNER JOIN tbl_pengajuan USING(nomor_pengajuan) ORDER BY tbl_penyelesaian_kekurangan.id_penyelesaian DESC")->result_array();
        $identitas = $departemen;
		
		$data_jb = $this->M_master->tampil_relasi_biaya(array('departemen' => $identitas))->result_array();
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_inquiry_kekurangan_all', array('data_inquiry' => $data_inquiry));
	...
	public function detail($id){
		...
		$this->load->view('header');
		$this->load->view('sidebar', array('data_jb'=>$data_jb));
		$this->load->view('v_inquiry_kekurangan_detail_all', array(
	...
	public function cancel(){
		...
		$result = $this->M_master->update_pengajuan('tbl_penyelesaian_kekurangan', array(
			'status_approve_penyelesaian' => 'cancel by request',
		...
		if($result > 0){
			echo '<script>
				alert("Penyelesaian Berhasil Di Cancel");window.location="index";
			</script>';
		}
	}

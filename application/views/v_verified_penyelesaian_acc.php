...
<section class="content-header">
  <h1>
    Penyelesaian Kekurangan Biaya (Verified By Accounting)
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Penyelesaian Kekurangan Biaya (Verified By Accounting)</h3>
        ...
        <div class="box-body">
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align:center"><?php echo $row_inquiry['status_verifikasi_penyelesaian'] ?></td>

              <!-- Kolom Action -->
              <td style="text-align: center;">

                <a href="<?php echo base_url().'inquiry_kekurangan_biaya/detail_verified_acc/'.$row_inquiry['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

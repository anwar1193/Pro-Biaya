...
<section class="content-header">
  <h1>
    Data Inquiry Penyelesaian Biaya Dikembalikan
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Inquiry Penyelesaian Biaya Dikembalikan</h3>
        ...
        <div id="jenis_biaya"><br>
          <form method="POST" action="<?php echo base_url().'inquiry_biaya_dikembalikan' ?>">
            <table>
              <tr>
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'inquiry_biaya_dikembalikan/detail/'.$row_inquiry['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

              ...
              <div class="form-group">
                ...
                <table width="100%">
                  <tr>
                    ...
                    <td>
                      <input class="form-control" type="number" name="jumlah_bayar[]" placeholder="Masukkan Jumlah (Rp)" id="bayar3" readonly></input>
                    </td>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      function hitung_otomatis(){
        ...
        bayar3 = (total*1) - ((bayar1*1) + (bayar2*1)); //perkalian salah satu trik biar angka bisa ditambah
        $('#bayar3').val(bayar3);
      }

      // Panggil fungsi ubah data (realtime) saat form (price_item, qty_item, discount_item) di ketik / di klik
      $(document).on('keyup mouseup', '#bayar1, #bayar2', function(){
        hitung_otomatis();
      });

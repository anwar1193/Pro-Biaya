...
<section class="content-header">
  <h1>
    Detail Penyelesaian Biaya Dikembalikan
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <h4 style="text-align: center;">Detail Penyelesaian Biaya Dikembalikan</h4>
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <?php echo $data_penyelesaian['note_verifikasi_penyelesaian'] ?>
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'review_penyelesaian_dikembalikan' ?>" class="btn btn-danger btn-xs no-print">Kembali</a>
              </span>
...
<!-- Modal Verifikasi -->
<form action="<?php echo base_url().'review_penyelesaian_dikembalikan/verifikasi' ?>" method="post">

...
<section class="content-header">
  <h1>
    Data Review Penyelesaian Biaya Dikembalikan
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Review Penyelesaian Biaya Dikembalikan</h3>
        ...
        <div class="box-body">
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: right;"><?php echo number_format($row_review['selisih'],0,',','.') ?></td>
              <td><?php echo date('d-m-Y', strtotime($row_review['tanggal_penyelesaian'])) ?></td>
              <td style="font-weight:bold"><?php echo $row_review['status_verifikasi_penyelesaian'] ?></td>

              <!-- Kolom Action -->
              <td style="text-align: center;">

                <a href="<?php echo base_url().'review_penyelesaian_dikembalikan/detail/'.$row_review['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">
                  <i class="fa fa-check-square-o"></i> Review Penyelesaian
                </a>

                <a href="<?php echo base_url().'review_penyelesaian_dikembalikan/jurnal_balik/'.$row_review['id_penyelesaian'] ?>" class="btn btn-success btn-xs" target="_blank">

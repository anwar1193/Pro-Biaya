  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data History Hapus Session
        <small>PT Procar Int'l Finance</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data Hapus Session</li>
      </ol>
    </section>
      ...
      <div class="box">
            ...
            <div class="box-body">
              <table id="tableDT" class="table table-bordered table-striped">
                ...
                <?php
                  $no=1;
                  foreach($data_clearlog as $row_clearlog){
                ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?php echo $row_clearlog['username'] ?></td>
                  <td><?php echo $row_clearlog['clearlog_waktu'] ?></td>
                  <td><?php echo $row_clearlog['clearlog_ip'] ?></td>
                  <td><?php echo $row_clearlog['clearlog_browser'] ?></td>
                </tr>
                <?php } ?>
                </tbody>
              </table>

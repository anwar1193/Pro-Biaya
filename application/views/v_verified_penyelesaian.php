...
<section class="content-header">
  <h1>
    Penyelesaian Kekurangan Biaya (Verified)
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Penyelesaian Kekurangan Biaya (Verified)</h3>
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'inquiry_kekurangan_biaya/detail_verified/'.$row_inquiry['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

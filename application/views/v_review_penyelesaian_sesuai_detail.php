        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'review_penyelesaian_sesuai' ?>" class="btn btn-danger btn-xs no-print">Kembali</a>
              </span>
...
<!-- Modal Verifikasi -->
<form action="<?php echo base_url().'review_penyelesaian_sesuai/verifikasi' ?>" method="post">

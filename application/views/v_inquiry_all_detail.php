      ...
      <div class="box">
            <div class="box-body">
              ...
              <div class="row">
                ...
                <?php } ?>
                  ...
                  <table class="table">
                    ...
                    <?php if($data_pengajuan['status_approve'] != 'cancel' && $data_pengajuan['status_approve'] != 'cancel by request'){ ?> <!-- Jika Status Cancel, Tanggal Bayar Tidak Tampil -->
                    ...
                    <!-- Data Tanggal Setuju Bayar & Bayar Final -->
                    <tr style="background-color: orange">
                      <td colspan="3">
                        <b>Tanggal Proses Bayar (BMHD) & Bayar (Payment) Finance</b>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <th>Tanggal Proses Bayar</th>
                      <th>:</th>
                      <td>
                        <?php if($data_pengajuan['tanggal_proses_bayar'] != '0000-00-00'){ ?>
                          <?php echo date('d-m-Y', strtotime($data_pengajuan['tanggal_proses_bayar'])) ?>
                          (<?php echo $data_bayar['jam_proses_bayar'] ?>)
                        <?php }else{ ?>
                          <?php echo 'Belum Di Proses'; ?>
                        <?php } ?>
                      </td>
                    </tr>

                    <tr>
                      <th>Tanggal Bayar (Final)</th>
                      <th>:</th>
                      <td>
                        <?php if($frek_byr > 1){ //jika pembayaran lebih dari 1 kali ?>

                          <?php if($data_bayar['jam_bayar'] != ''){ ?>
                            <?php echo date('d-m-Y', strtotime($data_bayar['tanggal_bayar'])) ?>
                            (<?php echo $data_bayar['jam_bayar'] ?>)
                          <?php }else{ ?>
                            <?php echo 'Belum Di Bayar'; ?>
                          <?php } ?>

                        <?php }else{ //jika pembayaran hanya sekali ?>

                          <?php if($data_pengajuan['tanggal_bayar'] == '0000-00-00'){ ?>
                            <?php echo 'Belum Di Bayar'; ?>
                          <?php }else{ ?>
                            <?php echo date('d-m-Y', strtotime($data_pengajuan['tanggal_bayar'])) ?>
                            (<?php echo $data_bayar['jam_bayar'] ?>)
                          <?php } ?>
                    ...
                    <!-- Data Cancel -->
                    <?php if($data_pengajuan['status_approve'] == 'cancel' || $data_pengajuan['status_approve'] == 'cancel by request'){ ?>
                      <tr style="background-color: red; color: white">
                        <th colspan="3">Pengajuan Ini Telah Di Cancel (Di Batalkan)</th>
                      </tr>

                      <tr>
                        <th>Alasan Cancel Pengajuan</th>
                        <th>:</th>
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  <span>
                    <a href="<?php echo base_url().'inquiry_all' ?>" class="btn btn-danger btn-xs">Kembali</a>
                  </span>

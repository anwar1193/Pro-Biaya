<?php date_default_timezone_set("Asia/Jakarta"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Persetujuan Penyelesaian Kekurangan Biaya (Direktur Finance)
              ...
              <table id="tableDT" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <a href="<?php echo base_url().'inbox_penyelesaian_dirfin/detail/'.$row_inbox['id_penyelesaian'] ?>" class="btn btn-success btn-xs">

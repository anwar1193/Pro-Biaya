        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <?php } ?>
              ...
              <h4 style="text-align: center;">Detail Pending Penyelesaian</h4>
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'pending_penyelesaian' ?>" class="btn btn-danger btn-xs">Kembali</a>
              </span>

            ...
            <div class="box-body">
                  ...
                  <table class="table">
                    ...
                    <?php if($data_pengajuan['balik_lagi'] == 'Ya'){ ?>
                      ...
                      <tr>
                        ...
                        <th>:</th>
                        <td><?php echo 'Rp '.number_format($data_pengajuan['harga_sebelumnya'],'0',',','.') ?></td>
                      </tr>
                    <?php } ?>
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dashed gray; padding: 10px;">
                  ...
                  <span>
                    <a href="<?php echo base_url().'inbox_dirfin' ?>" class="btn btn-primary btn-xs">
  ...
  <!-- Modal Reject -->
  <form action="<?php echo base_url().'inbox_dirfin/reject' ?>" method="post">
  ...
  <!-- Modal Approve -->
  <form action="<?php echo base_url().'inbox_dirfin/approve' ?>" method="post">
  ...
  <!-- Modal Revisi -->
  <form action="<?php echo base_url().'inbox_dirfin/revisi' ?>" method="post">

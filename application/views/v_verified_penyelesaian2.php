...
<section class="content-header">
  <h1>
    Data Penyelesaian Kelebihan Biaya (Verified)
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Penyelesaian Kelebihan Biaya (Verified)</h3>
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'inquiry_kelebihan_biaya/detail/'.$row_inquiry['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

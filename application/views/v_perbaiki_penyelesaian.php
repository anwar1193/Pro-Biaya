...
<h1>
Revisi Penyelesaian Kekurangan Biaya
...
<div class="box-body">
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3">
      ...
      <h3 style="text-align:center">Revisi Penyelesaian (Kekurangan Biaya)</h3>
      <hr style="border-width: 4px;">
      <form method="post" action="<?php echo base_url().'kekurangan_biaya/update' ?>">

      <input type="text" name="id_penyelesaian" id="id_penyelesaian" value="<?php echo $data_penyelesaian['id_penyelesaian'] ?>" hidden>

        <div>
          <label for="barcode">Nomor Pengajuan</label>
        </div>
        <div class="form-group input-group">
          <input type="text" name="nomor_pengajuan" id="nomor_pengajuan" class="form-control" required value="<?php echo $data_penyelesaian['nomor_pengajuan'] ?>" readonly>
          <span class="input-group-btn">
            <button class="btn btn-default btn-flat disabled" type="button" data-toggle="modal" data-target="#">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nomor_invoice" id="nomor_invoice" class="form-control" required autocomplete="off" value="<?php echo $data_penyelesaian['nomor_invoice'] ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="sub_biaya" id="sub_biaya" class="form-control" readonly value="<?php echo $data_penyelesaian['sub_biaya'] ?>">
        </div>

        <div class="form-group">
          <label for="jumlah">Total Pengajuan</label>
          <input type="text" name="jumlah" id="jumlah" class="form-control" readonly value="<?php echo $data_penyelesaian['total_pengajuan'] ?>">
        </div>

        <div class="form-group">
          <label for="realisasi">Realisasi (Rekomendasi Reviewer)</label>
          <input type="text" value="<?php echo $data_penyelesaian_pengajuan['nominal_penyelesaian_reviewer'] ?>" class="form-control" id="realisasi_reviewer" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off" readonly>
        </div>

        <div class="form-group">
          <label for="realisasi">Realisasi</label>
          <input type="text" name="realisasi" id="realisasi" class="form-control" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off" value="<?php echo $data_penyelesaian['realisasi'] ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="kurang_bayar" name="kurang_bayar" hidden value="<?php echo $data_penyelesaian['kurang_bayar'] ?>">
        </div>

        <div class="form-group">
          <label for="bank_penerima">Bank Penerima</label>
          <select name="bank_penerima" id="bank_penerima" class="form-control" required="">
              <option value="<?php echo $data_penyelesaian['bank'] ?>"><?php echo $data_penyelesaian['bank'] ?></option>
        ...
        <div class="form-group">
          ...
          <input type="text" name="norek_penerima" id="norek_penerima" class="form-control" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off" value="<?php echo $data_penyelesaian['nomor_rekening'] ?>">
        </div>

        <div class="form-group">
          <label for="atas_nama">Atas Nama</label>
          <input type="text" name="atas_nama" id="atas_nama" class="form-control" required autocomplete="off" value="<?php echo $data_penyelesaian['atas_nama_bank'] ?>">
        </div>

        <div class="form-group">
          <label for="tanggal_request_transfer">Tanggal (Request Transfer Kekurangan Bayar)</label>
          <input type="date" name="tanggal_request_transfer" id="tanggal_request_transfer" class="form-control" required value="<?php echo $data_penyelesaian['tanggal_request_transfer'] ?>">
        </div>

        <div class="form-group">
          <label for="kronologis">Kronologis Kekurangan Bayar :</label>
          <textarea class="form-control" name="kronologis" id="kronologis" required>
        ...
        <input type="text" name="departemen_tujuan" id="departemen_tujuan" hidden value="<?php echo $data_penyelesaian['departemen_tujuan'] ?>">
...
// Hitung Kurang Bayar Saat Halaman di Load
var jumlah_direct = $('#jumlah').val();
var realisasi_direct = $('#realisasi').val();
var kurang_bayar_direct = (realisasi_direct * 1) - (jumlah_direct * 1);
$('#kurang_bayar_text').text('Rp ' + rubah(kurang_bayar_direct));

          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <form method="post" action="<?php echo base_url().'p_revisi/update' ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <?php }else{ ?>
                      <div class="form-group">
                        <label for="jumlah">Jumlah :</label>
                        <input type="text" name="jumlah" id="jumlah" class="form-control" required value="<?php echo $data_pengajuan['jumlah'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off">
                      </div>

                      <div class="form-group">
                        <label for="ppn">PPN :</label>
                        <input type="text" name="ppn" id="ppn" class="form-control" required value="<?php echo $data_pengajuan['ppn'] ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off">
                      </div>
                    <?php } ?>

                    <input type="number" name="pph23" id="pph23" required value="<?php echo $data_pengajuan['pph23'] ?>" readonly hidden>
                    ...
                    <div class="form-group" id="pembayaran_1">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar1" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar1" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_2">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar2" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar2" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_3">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar3" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar3" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_4">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar4" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar4" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_5">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar5" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar5" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_6">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar6" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar6" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_7">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar7" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar7" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_8">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar8" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar8" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_9">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar9" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar9" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_10">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar10" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar10" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_11">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar11" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar11" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                    ...
                    <div class="form-group" id="pembayaran_12">
                      ...
                      <table width="100%">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" name="jumlah_bayar[]" id="bayar12" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>

                          <td>
                            <input type="text" name="ppn_bayar[]" id="ppn_bayar12" class="form-control" min="0" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                          </td>
                ...
                <br><br>
                <!-- Notif tombol muncul -->
                <span id="notif" style="color:red;">
                  Tombol <b>"Update Pengajuan"</b> Akan Tampil Jika <b>Total Pengajuan Sudah Sesuai<b> & </b>Tipe Transaksi</b> Sudah Dipilih
                </span>
  ...
  <script type="text/javascript">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        // ketika ubah harga / ppn, maka perlakuan nya sama dengan ubah tipe transaksi
        $(document).on('keyup mouseup', '#jumlah, #ppn', function(){
          $('#tombol_kirim').hide();
          $('#ubah_tipetrans').show();
          $('#notif').show();
          $('#tanggal1').attr("required","");
        ...
        function tampilkan_tombol(){
          ...
          if(jumlah_atas == total_fr && ppn_atas == total_ppn && jumlah_atas!=0 && jenis_pembayaran!=0){
            $('#tombol_kirim').show();
            // $('#tombol_kirim2').show();
            $('#tombol_reset').show();
            $('#notif').hide();
  ...
  <!-- Script Upload Multiple File -->
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        // // Setelah tombol tgl_min_bayar1 s/d tgl_min_bayar12, tombol tsb menghilang

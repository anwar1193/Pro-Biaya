<?php  
	...
	header("Content-Disposition: attachment; filename=report dok terlambat.xls");
...
<h3 style="text-align: center;">Data Pengajuan (Dokumen Terlambat)</h3>
    ...
    <table border="1" width="100%" style="margin-top: 20px; font-size: 15px">
    ...
    <tr>
        ...
        <td style="text-align:center"><?= $row_pengajuan['dept_tujuan'] ?></td>

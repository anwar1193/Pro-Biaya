			...
			<td style="text-align: center">
				<?php  
					$app_kadept = $this->db->query("SELECT * FROM tbl_pengajuan WHERE
						dept_tujuan='$departemen' AND sub_biaya='$sub_biaya' AND (tanggal BETWEEN '$tanggal_from' AND '$tanggal_to') AND approved_by='dept head pic' OR

						dept_tujuan='$departemen' AND sub_biaya='$sub_biaya' AND (tanggal BETWEEN '$tanggal_from' AND '$tanggal_to') AND approved_by='division head' OR

						dept_tujuan='$departemen' AND sub_biaya='$sub_biaya' AND (tanggal BETWEEN '$tanggal_from' AND '$tanggal_to') AND approved_by='director' OR

						dept_tujuan='$departemen' AND sub_biaya='$sub_biaya' AND (tanggal BETWEEN '$tanggal_from' AND '$tanggal_to') AND approved_by='director finance' OR

						dept_tujuan='$departemen' AND sub_biaya='$sub_biaya' AND (tanggal BETWEEN '$tanggal_from' AND '$tanggal_to') AND approved_by='president director'

...
<section class="content-header">
  <h1>
    Detail Penyelesaian Kekurangan Biaya (Pending)
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <h4 style="text-align: center;">Detail Penyelesaian Kekurangan Biaya (Pending)</h4>
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td style="font-weight:bold; color:orange">
                    <?php  
                        echo $data_penyelesaian['note_verifikasi_penyelesaian'];
                    ?>
                  </td>
                </tr>
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'inquiry_kekurangan_biaya/perbaiki_pending/'.$data_penyelesaian['id_penyelesaian'] ?>" class="btn btn-info btn-xs">Perbaiki</a>
              </span>

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Inquiry Pembayaran - Proses Bayar
    ...
    <section class="content">
      ...
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Proses Bayar</h3>
            ...
            <button class="btn btn-info btn-sm" id="tombol1">Tanggal Rencana Bayar</button>
            ...
            <!-- Reset Filter -->
            <form method="POST" action="<?php echo base_url().'history_bayar' ?>" style="float: left;">
            ...
            <!-- Filter by Tanggal Rencana Bayar -->
              &nbsp;
              <div id="tanggal_rencana_bayar"><br>
              <form method="POST" action="<?php echo base_url().'history_bayar' ?>">
                <table>
                  <tr>
                    <td>(FILTER By Tgl Rencana Bayar) - &nbsp;</td>
              ...
              <table id="tableDT" class="table table-bordered table-striped">
                ...
                <tr style="text-align: center">
                  ...
                  <th>Jumlah Biaya</th>
                  <th>Bank</th>
                  <th width="8%">Tgl Proses PIC Finance</th>
                ...
                <tr style="text-align: center">
                  ...
                  <td><?php echo date('d-m-Y',strtotime($row_bayar['tanggal_proses_bayar'])) ?></td>
                  ...
                  <td style="text-align: center;">
                    ...
                    <a href="<?php echo base_url().'history_bayar/detail/'.$row_bayar['id'] ?>" class="btn btn-info btn-xs">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#tanggal_rencana_bayar').hide();
      $('#jenis_biaya').hide();
      $('#cabang').hide();
      $('#departemen').hide();

      $(document).on('click', '#tombol1', function(){
        $('#tanggal_rencana_bayar').slideDown(1000);
        $('#jenis_biaya').hide();
        $('#cabang').hide();
        $('#departemen').hide();
      });

...
<section class="content-header">
  <h1>
    Data Inquiry Penyelesaian Kelebihan Biaya (ALL)
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Inquiry Penyelesaian Kelebihan Biaya (ALL)</h3>
        ...
        <div class="box-body">
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr>
              ...
              <th style="text-align: center">Lebih Bayar</th>
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: right;"><?php echo number_format($row_inquiry['lebih_bayar'],0,',','.') ?></td>
              <td><?php echo date('d-m-Y', strtotime($row_inquiry['tanggal_pengembalian'])) ?></td>
              <td><?php echo $row_inquiry['departemen_tujuan'] ?></td>
              <td style="font-weight:bold"><?php echo $row_inquiry['status_penyelesaian'] ?></td>

              <!-- Kolom Action -->
              <td style="text-align: center;">

                <a href="<?php echo base_url().'inquiry_kelebihan_biaya_all/detail/'.$row_inquiry['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">
...
<!-- Modal Cancel -->
<form action="<?php echo base_url().'inquiry_kelebihan_biaya_all/cancel' ?>" method="post">

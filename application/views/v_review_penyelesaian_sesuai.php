...
<section class="content-header">
  <h1>
    Data Review Penyelesaian Biaya Sesuai
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Review Penyelesaian Biaya Sesuai</h3>
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'review_penyelesaian_sesuai/detail/'.$row_review['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

...
<?php  
  ...
  $no_pengajuan = $row_pengajuan['nomor_pengajuan'];
...
<body>
	...
	<h4 style="text-align: center;">Detail Pengajuan Biaya (Payment)</h4><br><br>
	<div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
      ...
      <table width="100%" border="1" style="font-size: 12px;">
        ...
        <tr>
          ...
          <th>:</th>
          <td><?php echo number_format($row_pengajuan['jumlah'],0,',','.') ?></td>
        </tr>

        <tr>
          <th style="text-align: right;">PPN</th>
          <th>:</th>
          <td><?php echo number_format($row_pengajuan['ppn'],0,',','.') ?></td>
        </tr>

        <tr>
          <th style="text-align: right;">PPH23</th>
          <th>:</th>
          <td><?php echo number_format($row_pengajuan['pph23'],0,',','.') ?></td>
        </tr>

        <tr>
          <th style="text-align: right;">PPH21</th>
          <th>:</th>
          <td><?php echo number_format($row_pengajuan['pph21'],0,',','.') ?></td>
        </tr>

        <tr>
          <th style="text-align: right;">PPH4(2)</th>
          <th>:</th>
          <td><?php echo number_format($row_pengajuan['pph42'],0,',','.') ?></td>
        </tr>
          ...
          <td>
            <ul>
              <?php if($row_pengajuan['status_check'] == 'Checked'){ ?>
                ...
                <li style="color: green; font-weight: bold; margin-bottom: 5px">
                  <?php echo $row_pengajuan['status_check'] ?> by <?php echo $row_pengajuan['checked_by'] ?> <br>
                  <small>(on <?php echo date('d-m-Y', strtotime($row_pengajuan['checked_on'])) ?>)</small>
                </li>

              <?php }elseif($row_pengajuan['status_check'] == 'Pending'){ ?>

                <li style="color: orange; font-weight: bold; margin-bottom: 5px">
                  <?php echo $row_pengajuan['status_check'] ?> by <?php echo $row_pengajuan['checked_by'] ?> <br>
                  <small>(on <?php echo date('d-m-Y', strtotime($row_pengajuan['checked_on'])) ?>)</small>
                  <br>
                  Note : "<?php echo $row_pengajuan['alasan_pending'] ?>"
                </li>
        ...
        <tr>
          ...
          <td style="font-weight: bold">
            <?php 
              if($row_pengajuan['status_bayar'] == 'Telah Dibayar'){
                echo $row_pengajuan['status_bayar']; 
              }elseif($row_pengajuan['status_bayar'] == 'Proses Bayar'){
                echo $row_pengajuan['status_bayar']; 
              }else{
                echo 'Proses Check';
              }
        ...
        <tr>
          <th style="text-align: left;">Tanggal Janji Bayar</th>
          <th>:</th>
          <td>
            <?php 
              if($row_pengajuan['tanggal_bayar']=='0000-00-00'){
                echo '-';
              }else{
                echo date('d-m-Y', strtotime($row_pengajuan['tanggal_bayar'])) ;
              }
            ?>
          </td>
        </tr>
        ...
        <tr>
          ...
          <th>:</th>
          <td><?php echo $row_pengajuan['catatan'] ?></td>
        </tr>

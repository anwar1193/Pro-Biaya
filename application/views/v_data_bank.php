  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Bank Pengaju</li>
      </ol>
    </section>
      ...
      <div class="box">
            ...
            <div class="box-body">
              <table id="tableDT" class="table table-bordered table-striped">
                ...
                <?php
                  $no=1;
                  foreach($data_bank as $row_bank){
                ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  <td><?php echo $row_bank['nama_bank'] ?></td>
                  <td style="text-align: center;">

                    <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal-edit"
                      data-id = "<?php echo $row_bank['id_bank'] ?>"
                      data-nama_bank = "<?php echo $row_bank['nama_bank'] ?>"
                      id="pilih_edit"
                    >
                      <i class="fa fa-edit"></i> Edit
                    </button>

                    <a href="<?php echo base_url().'data_bank/hapus/'.$row_bank['id_bank'] ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda Yakin?')">
  ...
  <!-- Modal Tambah -->
  <form action="<?php echo base_url().'data_bank/simpan' ?>" method="post">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="nama_bank"></span> Nama Bank :</label>
  ...
  <!-- Modal Edit -->
  <form action="<?php echo base_url().'data_bank/update' ?>" method="post">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="nama_bank"></span> Nama Bank :</label>
            <input type="text" name="nama_bank" class="form-control" id="nama_bank" autocomplete="off" required>
          </div>

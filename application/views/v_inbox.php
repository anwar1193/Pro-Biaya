    ...
    <section class="content">
      ...
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Persetujuan Pengajuan</h3>
              ...
              <table id="tableDT" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    ...
                    <a href="<?php echo base_url().'inbox/detail/'.$row_inbox['id_pengajuan'] ?>" class="btn btn-info btn-xs">

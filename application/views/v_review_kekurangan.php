...
<section class="content-header">
  <h1>
    Data Review Penyelesaian Kekurangan Biaya
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Review Penyelesaian Kekurangan Biaya</h3>
          ...
          <table id="tableDT" class="table table-bordered table-striped" style="margin-top: 10px">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'review_kekurangan_biaya/detail/'.$row_review['id_penyelesaian'] ?>" class="btn btn-warning btn-xs">

 ...
 <?php date_default_timezone_set("Asia/Jakarta"); ?>
            ...
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <form method="post" action="<?php echo base_url().'p_approved/update' ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="atas_nama" id="atas_nama" class="form-control" required value="<?php echo $data_pengajuan['atas_nama'] ?>">
                </div>
                  ...
                  <table width="70%" border="1" style="border-collapse: collapse;">
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        ...
                        <a onclick="return confirm('Anda Yakin Akan Menghapus File Ini?')" href="<?php echo base_url().'p_approved/hapus_file/'.$row_berkas['id'].'/'.$data_pengajuan['id_pengajuan'] ?>" class="btn btn-danger btn-xs">Hapus</a>
                      </td>
                    </tr>
                    <?php } ?>
                  </table>            
  ...
  <!-- Script Upload Multiple File -->
    ...
    <script src="<?php echo base_url().'js_custom/validasi_th_pending.js' ?>"></script>
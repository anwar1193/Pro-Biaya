            ...
            <div class="box-body">
                    ...
                    <tr>
                      ...
                      <td>
                        <ul>
                          ...
                          <li>
                            ...
                            <?php if($row_file['status']==''){ ?>
                              ...
                              <!-- <form method="post" action="<?php echo base_url().'history_pengajuan/check_dokumen' ?>">
                        ...
                        <?php if($data_pengajuan['tambah_dokumen'] == 'ya'){ ?>
                          <span style="color: green; font-weight: bold;">
                            - Request Tambah Dokumen Terkirim - 
                          </span>
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  ...
                  <span>
                    <a href="<?php echo base_url().'history_pengajuan' ?>" class="btn btn-danger btn-xs">Kembali</a>
                  </span>

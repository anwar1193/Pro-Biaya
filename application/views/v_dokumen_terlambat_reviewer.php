...
<section class="content-header">
  <h1>
    Data Pengajuan (Dokumen Terlambat) Reviewer
...
<section class="content">
  ...
  <div class="box">
        <div class="box-header">
          <h3 class="box-title">Pengajuan (Dokumen Terlambat) Reviewer</h3>
          ...
          <table id="tableDT" class="table table-bordered table-striped">
            ...
            <tr style="text-align: center">
              ...
              <td style="text-align: center;">
                ...
                <a href="<?php echo base_url().'dokumen_terlambat_reviewer/detail/'.$row_dokterlambat['id_pengajuan'] ?>" class="btn btn-warning btn-xs">

      ...
      <div class="box">
            <div class="box-body">
              ...
              <div class="row">
                ...
                <?php } ?>
                  ...
                  <table class="table">
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            <?php if($row_file['status']==''){ ?>
                              ...
                              <form method="post" action="<?php echo base_url().'all_pengajuan_tanggal/check_dokumen' ?>">
                            ...
                            <?php }elseif($row_file['status']=='Done'){ ?>
                              <span style="color: green; font-weight: bold;">
                                Diterima Oleh <?php echo $data_pengajuan['dept_tujuan'] ?>
                              </span>

                            <?php }elseif($row_file['status']=='Done ACC'){ ?>
                              <span style="color: green; font-weight: bold;">
                                Diterima Oleh Accounting
                              </span>
                    ...
                    <tr>
                      <th>Tanggal Bayar (Warna Hijau = Telah Dibayar)</th>
                      <th>:</th>
                      <td>
                        ...
                        <table border="1" style="border-collapse: collapse;" width="100%">
                          ...
                          <?php }else{ //jika bayar lebih dari sekali, panggil dari tbl_bayar ?>
                            ...
                            ?>
                              ...
                              <tr style="<?= $row_byr2['status_bayar']=='Telah Dibayar' ? 'background-color:#bbff99' : NULL ?>">
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  <!-- <span>
                    <a href="<?php echo base_url().'all_pengajuan_tanggal' ?>" class="btn btn-danger btn-xs">Kembali</a>
                  </span> -->

                  <span>
                    <a target="_blank" href="<?php echo base_url().'all_pengajuan_tanggal/pdf_pengajuan/'.$data_pengajuan['id_pengajuan'] ?>" class="btn btn-warning btn-xs"><i class="fa fa-print"></i> Export PDF</a>
                  </span>
                  ...
                  <?php if($data_pengajuan['status_dokumen']=='done' AND $data_pengajuan['tambah_dokumen'] != 'ya'){ ?>

                    <a href="<?php echo base_url().'all_pengajuan_tanggal/verifikasi_dokumen/'.$data_pengajuan['id_pengajuan'] ?>" class="btn btn-xs btn-primary" onclick="return confirm('Apakah Anda Yakin Accounting Telah Menerima Seluruh Dokumen di Pengajuan Ini?')">
                      Konfirmasi Dokumen Diterima ACC
                    </a>
  ...
  <!-- Modal Dokumen -->
  <form action="<?php echo base_url().'all_pengajuan_tanggal/request_dokumen' ?>" method="post">

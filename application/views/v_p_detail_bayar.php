            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <?php } ?>
                  ...
                  <table class="table">
                    ...
                    <?php if($frek_byr == 1){ // Jika hanya sekali bayar, tampilkan dari tbl_pengajuan ?>
                      ...
                      <tr style="background-color: orange">
                        <th style="text-align: right;">Total Harus Dibayar</th>
                        <th>:</th>
                    ...
                    <?php }else{ //Jika Lebih dari sekali Bayar, Tampilkan Dari tbl_bayar ?>

                      <tr>
                        <th style="text-align: right;">Jumlah</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['jumlah_bayar'],0,'.',',') ?></td>
                      </tr>

                      <tr>
                        <th style="text-align: right;">PPN</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['ppn_bayar'],0,'.',',') ?></td>
                      </tr>

                      <tr>
                        <th style="text-align: right;">PPH23</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['pph23_bayar'],0,'.',',') ?></td>
                      </tr>

                      <tr>
                        <th style="text-align: right;">PPH 4(2)</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['pph42_bayar'],0,'.',',') ?></td>
                      </tr>

                      <tr>
                        <th style="text-align: right;">PPH 21</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['pph21_bayar'],0,',','.') ?></td>
                      </tr>

                      <tr style="background-color: orange">
                        <th style="text-align: right;">Total Harus Dibayar</th>
                        <th>:</th>
                        <td><?php echo number_format($data_pengajuan['jumlah_bayar']+$data_pengajuan['ppn_bayar']-($data_pengajuan['pph23_bayar']+$data_pengajuan['pph42_bayar']+$data_pengajuan['pph21_bayar']),0,'.',',') ?></td>
                      </tr>

                    <?php } //penutup kondisi sekali bayar atau lebih dari sekali bayar ?>
                    ...
                    <tr>
                      ...
                      <?php }else{ // jika lebih dari sekali pembayaran ?>
                        ...
                        <td><?php echo 'Pembayaran Ke-'.$data_pengajuan['pembayaran_ke'] ?></td>
                    ...
                    <!-- Jika Pernah Direvisi Oleh Finance -->
                    <?php if($data_pengajuan['revisi_finance'] != ''){ ?>

                      <tr style="background-color: orange">
                        <td colspan="3">
                          <b>Revisi By Finance Dept</b>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <th>:</th>
                        <td>
                          <?php if($data_pengajuan['revisi_finance'] == 'ya'){ ?>
                            <span style="font-weight: bold">Terkirim Ke PIC Departemen</span>
                          <?php }elseif($data_pengajuan['revisi_finance'] == 'telah direvisi'){ ?>
                            <span style="font-weight: bold">Telah Di Revisi Oleh PIC Departemen</span>
                          <?php } ?>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <th>:</th>
                        <td>
                          <span><?php echo $data_pengajuan['ket_refin'] ?></span>
                        </td>
                      </tr>
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  ...
                  <span>
                    <a href="<?php echo base_url().'p_bayar' ?>" class="btn btn-danger btn-xs">
                      <i class="fa fa-backward"></i> Kembali
                    </a>
                  </span>

                  <span>
                    <button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-revisi">
                      <i class="fa fa-refresh"></i> Revisi Ke Departemen
                    </button>
                  </span>
                 ...
                 <!--  <span>
                    <a href="#" data-toggle="modal" data-target="#modal-bayar" class="btn btn-success btn-xs">
                      <i class="fa fa-dollar"></i> Setujui Bayar
                    </a>
                  </span> -->
  ...
  <!-- Modal Revisi -->
  <form action="<?php echo base_url().'p_bayar/revisi_dept' ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Ajukan Revisi Ke PIC Dept</h4>
        </div>
        <div class="modal-body">

          <input type="text" hidden name="id" value="<?php echo $data_pengajuan['id'] ?>">
          ...
          <input type="date" hidden name="tanggal" value="<?php echo $data_pengajuan['tanggal'] ?>">
          <input type="text" hidden name="sub_biaya" value="<?php echo $data_pengajuan['sub_biaya'] ?>">
          <input type="text" hidden name="cabang" value="<?php echo $data_pengajuan['cabang'] ?>">
          <input type="text" hidden name="bagian" value="<?php echo $data_pengajuan['bagian'] ?>">
          <input type="text" hidden name="total" value="<?php echo $data_pengajuan['total'] ?>">
          <input type="text" hidden name="keterangan" value="<?php echo $data_pengajuan['keterangan'] ?>">
          <input type="text" hidden name="approved_by" value="<?php echo $data_pengajuan['approved_by'] ?>">
          <input type="text" hidden name="nama_pengapprove" value="<?php echo $data_pengajuan['nama_pengapprove'] ?>">
          <input type="date" hidden name="tanggal_approved" value="<?php echo $data_pengajuan['tanggal_approved'] ?>">
          <input type="date" hidden name="tanggal_reverse" value="<?php echo date('Y-m-d') ?>">

          <div class="form-group">
            <label for="ket_refin"></span> Keterangan Revisi :</label>
            <textarea class="form-control" name="ket_refin" required></textarea>
          </div>

        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-warning btn-sm pull-left" data-dismiss="modal"> Batal</button>
          <button type="submit" class="btn btn-sm btn-success"> Ajukan Revisi</button>
        </div>
      </div>
      <!-- /.modal-content -->
    </div>

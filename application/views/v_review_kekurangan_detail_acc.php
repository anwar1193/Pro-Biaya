        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'review_kekurangan_accounting' ?>" class="btn btn-danger btn-xs no-print">Kembali</a>
              </span>

              <span>
                <a href="<?php echo base_url().'kekurangan_biaya/detail/'.$data_pengajuan['id_pengajuan'] ?>" class="btn btn-info btn-xs no-print" target="_blank">Detail Pengajuan</a>
              </span>

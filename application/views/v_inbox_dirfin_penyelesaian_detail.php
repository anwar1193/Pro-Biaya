        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
              ...
              <span>
                <a href="<?php echo base_url().'inbox_penyelesaian_dirfin' ?>" class="btn btn-danger btn-xs">Kembali</a>
              </span>
              ...
              <span>
                <a href="#" data-toggle="modal" data-target="#modal-approve" class="btn btn-success btn-xs">Approve</a>
              </span>
...
<!-- Modal Approve -->
<form action="<?php echo base_url().'inbox_penyelesaian_dirfin/approve' ?>" method="post">
  ...
  <!-- Modal Revisi -->
<form action="<?php echo base_url().'inbox_penyelesaian_dirfin/revisi' ?>" method="post">
...
<!-- Modal Rejected -->
<form action="<?php echo base_url().'inbox_penyelesaian_dirfin/reject' ?>" method="post">

            ...
            <div class="box-body">
                ...
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                          if($data_pengajuan['tanggal_rencana_bayar']=='0000-00-00'){
                            echo '-';
                          }else{
                            echo date('d-m-Y', strtotime($data_pengajuan['tanggal_rencana_bayar'])) ;
                          }
                        ?>
                      </td>
                    </tr>
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  ...
                  <span>
                    <a href="<?php echo base_url().'p_bayar_final' ?>" class="btn btn-danger btn-xs">

    ...
    <div class="col-sm-6 col-sm-offset-3">
      ...
      <form method="post" action="<?php echo base_url().'kekurangan_biaya/simpan' ?>">
        ...
        <div class="form-group input-group">
          <input type="text" name="nomor_pengajuan" id="nomor_pengajuan" class="form-control" required autofocus value="<?php echo $nomor_pengajuan ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nomor_invoice" id="nomor_invoice" class="form-control" required autocomplete="off" value="<?php echo $nomor_invoice ?>">
        </div>

        <div class="form-group">
          <label for="jenis_biaya">Jenis Biaya</label>
          <input type="text" name="jenis_biaya" id="jenis_biaya" class="form-control" readonly value="<?php echo $jenis_biaya ?>">
        </div>

        <div class="form-group">
          <label for="sub_biaya">Sub Biaya</label>
          <input type="text" name="sub_biaya" id="sub_biaya" class="form-control" readonly value="<?php echo $sub_biaya ?>">
        </div>

        <div class="form-group">
          <label for="jumlah">Total Pengajuan</label>
          <input type="text" name="jumlah" id="jumlah" class="form-control" readonly value="<?php echo $total_pengajuan ?>">
        </div>

        <div class="form-group">
          <label for="realisasi">Realisasi</label>
          <input type="text" name="realisasi" id="realisasi" class="form-control" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off" value="<?php echo $realisasi ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="kurang_bayar" name="kurang_bayar" hidden value="<?php echo $kurang_bayar ?>">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="norek_penerima" id="norek_penerima" class="form-control" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" autocomplete="off" value="<?php echo $nomor_rekening ?>">
        </div>

        <div class="form-group">
          <label for="atas_nama">Atas Nama</label>
          <input type="text" name="atas_nama" id="atas_nama" class="form-control" required autocomplete="off" value="<?php echo $atas_nama_bank ?>">
        </div>

        <div class="form-group">
          <label for="tanggal_request_transfer">Tanggal (Request Transfer Kekurangan Bayar)</label>
          <input type="date" name="tanggal_request_transfer" id="tanggal_request_transfer" class="form-control" required value="<?php echo $tgl_request_transfer ?>">
        </div>
        ...
        <input type="text" name="departemen_tujuan" id="departemen_tujuan" value="<?php echo $departemen_tujuan ?>" hidden>

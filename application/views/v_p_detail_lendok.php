            ...
            <div class="box-body">
                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td style="font-weight: bold">
                        <?php 
                          if($data_pengajuan['status_bayar'] == 'Telah Dibayar' || $data_pengajuan['status_bayar'] == 'Proses Bayar'){
              ...
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3" style="border:1px dotted gray; padding: 10px;">
                  ...
                  <span>
                    <a href="<?php echo base_url().'p_dokumen_lengkap' ?>" class="btn btn-danger btn-xs">Kembali</a>
                  </span>

  ...
  <!-- Modal Dokumen -->
  <form action="<?php echo base_url().'p_on_proccess/tambahkan_dokumen' ?>" method="post" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
      ...
      function barisBaru(){
        ...
        var Baris = '<tr>';
                ...
                Baris += '<td>';
                  Baris += '<input type="file" id="pilih_file" name="files[]" class="form-control" placeholder="Upload File" required>';
                Baris += '</td>';

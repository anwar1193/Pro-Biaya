<?php date_default_timezone_set("Asia/Jakarta"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Pengajuan Bulan Lalu
        <small>PT Procar Int'l Finance</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Pengajuan Bulan Lalu</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pengajuan Bulan Lalu ( <?php echo $sub_biaya1 ?> - <?php echo $cabang1 ?> - <?php echo $bagian1 ?> )</h3>

              <!-- Tombol All Data Lalu -->
              <form action="<?php echo base_url().'inbox/detail_counter_lalu_all' ?>" method="post">
                <input type="text" name="sub_biaya" value="<?php echo $sub_biaya1 ?>" hidden>
                <input type="text" name="cabang" value="<?php echo $cabang1 ?>" hidden>
                <input type="text" name="bagian" value="<?php echo $bagian1 ?>" hidden>

                <button class="btn btn-success btn-xs" style="display: block; position: absolute; right: 10px; top: 10px;">
                  Lihat Semua Data
                </button>
              </form>
              <!-- Tombol All Data Lalu -->
                ...
                <tr>
                  ...
                  <?php if($row_pengajuan['status_approve'] == 'on proccess'){ ?>
                    ...
                    <td style="text-align:center">
                      <a href="<?php echo base_url().'inbox/detail_list_counter_lalu/'.$row_pengajuan['id_pengajuan'] ?>" class="btn btn-warning btn-xs">
